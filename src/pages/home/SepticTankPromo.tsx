  ...
  <section className="bg-[#FCFCFC] p-6 sm:p-10 border border-gray-200 mb-16 shadow-sm">
    <div className="flex flex-col md:flex-row gap-8 items-center justify-between">
      <div className="max-w-2xl">
        <h6 className="text-xs font-bold text-science-red uppercase tracking-[0.2em] mb-3">Preprint / 化粪池</h6>
        <h3 className="text-2xl font-serif font-bold text-charcoal mb-2">化粪池 Preprint 已开启</h3>
        <p className="text-base text-gray-500 font-sans">
          为你最喜爱的 SHIT 评分，高评分稿件可直达铲屎官餐桌。<br />
          Rate your favorite SHIT — top-rated manuscripts go straight to the Scoopers.
        </p>
      </div>
